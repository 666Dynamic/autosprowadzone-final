...
export const metadata: Metadata = {
  ...
  description:
    "Odpowiedzi na pytania o import aut z Niemiec: koszty sprowadzenia, stawki akcyzy 2026, czas transportu, procedury rejestracji, gwarancja i depozyt. Wszystko w jednym miejscu.",
  alternates: {
  ...
  openGraph: {
    title: "FAQ — Najczęściej Zadawane Pytania o Imporcie Aut",
    description:
      "Odpowiedzi na pytania o import aut z Niemiec: koszty, akcyza, transport, rejestracja.",
