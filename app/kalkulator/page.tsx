...
export const metadata: Metadata = {
  ...
  description:
    "Oblicz całkowity koszt sprowadzenia auta z Niemiec w 2026 roku. Sprawdź aktualne stawki akcyzy (3.1% / 18.6%), koszty rejestracji, transportu i prowizję pośrednika. Precyzyjne wyliczenie online.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Oblicz całkowity koszt sprowadzenia auta z Niemiec. Aktualne stawki akcyzy, koszty rejestracji i transportu.",
    ...
    <div className="w-full overflow-x-hidden">
      ...
      <div className="w-full mx-auto max-w-6xl px-4 md:px-8 py-12 md:py-20">
        <div className="max-w-4xl mx-auto mb-12 text-center">
          <h1 className="text-3xl md:text-4xl font-black mb-6 uppercase tracking-tighter italic">
            Kalkulator{" "}
            <span className="text-primary not-italic">Kosztów Importu</span>
          </h1>
          <p className="text-lg text-muted-foreground font-medium max-w-2xl mx-auto">
            Skorzystaj z naszego precyzyjnego narzędzia, aby oszacować całkowity
            koszt sprowadzenia samochodu "pod dom". Uwzględniamy wszystkie
            opłaty urzędowe obowiązujące w 2026 roku.
          </p>
        </div>
        ...
        <div className="mt-32 max-w-6xl mx-auto relative px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start text-foreground">
            <div className="space-y-12 bg-transparent">
              ...
              <p className="text-lg leading-relaxed text-muted-foreground max-w-xl">
                Całkowity koszt importu to nie tylko cena na fakturze. W 2026
                roku musisz uwzględnić szereg opłat urzędowych oraz
                logistycznych.
              </p>
              ...
              <div className="space-y-10">
                <div className="group transition-all">
                  <h3 className="text-xl font-black mb-6 flex items-center gap-4 text-foreground uppercase tracking-tight">
                    <span className="w-10 h-10 rounded-xl bg-primary/10 dark:bg-primary/20 flex items-center justify-center text-primary text-sm font-black italic border border-primary/20">
                      01
                    </span>
                    Podatek Akcyzowy (AKC-U/S)
                  </h3>
                  <p className="text-sm text-muted-foreground leading-relaxed mb-6 font-medium">
                    To największy koszt dodatkowy. Stawka zależy od pojemności
                    silnika i rodzaju napędu:
                  </p>
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 list-none p-0 m-0">
                    {[
                      ...
                      <li
                        key={idx}
                        className="bg-card border border-border p-5 rounded-3xl flex flex-col group-hover:border-primary/40 transition-all shadow-sm"
                      >
                ...
                <div className="group transition-all">
                  <h3 className="text-xl font-black mb-6 flex items-center gap-4 text-foreground uppercase tracking-tight">
                    <span className="w-10 h-10 rounded-xl bg-muted flex items-center justify-center text-muted-foreground text-sm font-black italic border border-border">
                      02
                    </span>
                  ...
                  <div className="bg-muted border border-border p-6 md:p-8 rounded-2xl md:rounded-[2.5rem] group-hover:border-primary/20 transition-all">
                    <p className="text-base text-muted-foreground leading-relaxed m-0 italic font-medium">
                      Transport wyceniamy indywidualnie w zależności od
                      odległości. Koszt zazwyczaj mieści się w granicach{" "}
                      <span className="text-foreground font-bold not-italic underline decoration-primary/30 underline-offset-4">
                        1500 - 3500 zł
                      </span>
                      . Przy powrocie "na kołach" dolicz tablice zjazdowe (ok.
                      150-250 EUR).
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-card p-5 md:p-6 rounded-2xl md:rounded-2xl border border-border shadow-xl relative overflow-hidden group">
              ...
              <div className="space-y-8 relative">
                ...
                {[
                  ...
                  <div key={idx} className="relative pl-10 group/item">
                    <div
                      className={`absolute left-0 top-1.5 w-2 h-2 rounded-full border-2 transition-all ${item.active ? "bg-primary border-primary scale-150 shadow-[0_0_10px_rgba(245,158,11,0.5)]" : "bg-card border-muted-foreground/30 group-hover/item:border-primary"}`}
                    />
                    <h4
                      className={`font-black text-xs uppercase tracking-[0.2em] mb-3 transition-colors ${item.active ? "text-primary" : "text-muted-foreground group-hover/item:text-primary"}`}
                    >
                      {item.step}
                    </h4>
              ...
              <div className="mt-8 pt-6 border-t border-border flex items-start gap-3 px-2 p-5 bg-muted/30 rounded-lg">
                ...
                <p className="text-xs font-bold text-muted-foreground italic leading-relaxed m-0 uppercase tracking-wider">
                  Uwaga: Import z poza UE (np. Szwajcaria, USA) to dodatkowe{" "}
                  <span className="text-foreground font-black">Cło (10%)</span>{" "}
                  oraz{" "}
          ...
          <div className="bg-primary text-primary-foreground p-6 md:p-10 rounded-2xl md:rounded-3xl border-2 border-primary/20 mt-32 relative overflow-hidden group shadow-2xl shadow-primary/20">
            ...
            <div className="max-w-2xl relative z-10">
              <h3 className="text-primary-foreground text-2xl md:text-3xl font-black mb-6 uppercase tracking-tighter italic drop-shadow-md">
                Kompleksowa Obsługa
              </h3>
              <p className="text-primary-foreground/90 text-base leading-relaxed mb-0 font-bold italic drop-shadow-md">
                Przejmujemy na siebie cały proces: od wyszukania auta na
                aukcjach i weryfikacji na miejscu u dealera, przez negocjacje,
                po przygotowanie kompletu dokumentów do rejestracji. Ty tylko
                odbierasz samochód pod domem.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-32 max-w-4xl mx-auto px-4 pb-20">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black mb-6 uppercase tracking-tight italic text-foreground">
              Masz pytania co do wyceny?
            </h2>
            <p className="text-muted-foreground font-bold uppercase tracking-[0.2em]">
          ...
          <ContactForm
            ...
            description="Nasz ekspert pomoże Ci skalkulować opłacalność sprowadzenia danego egzemplarza."
          />
        </div>
      </div>
    </div>
