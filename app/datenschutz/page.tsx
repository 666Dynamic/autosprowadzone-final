...
export const metadata: Metadata = {
  ...
  description:
    "Datenschutzerklärung und Informationen zur Datenverarbeitung gemäß DSGVO. Miami Autocenter GmbH, Osterholz-Scharmbeck.",
  alternates: {
    ...
    <div lang="de" className="container mx-auto px-4 py-32 max-w-4xl">
      ...
      <div className="space-y-8">
        ...
        <Card className="border-2 border-border bg-card">
          <CardHeader>
            <CardTitle className="uppercase tracking-widest text-lg font-black text-muted-foreground">
              1. Datenschutz auf einen Blick
            </CardTitle>
          </CardHeader>
        ...
        <Card className="border-2 border-border bg-card">
          ...
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed text-sm">
            <div>
              ...
              <p className="mt-2">
                Wenn Sie unsere Website besuchen, erfasst Vercel verschiedene
        ...
        <Card className="border-2 border-border bg-card">
          ...
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed text-sm">
            ...
            <p>
              <strong className="text-foreground">Miami Autocenter GmbH</strong>
              <br />
              Bremer Heerstraße 7A
              <br />
            ...
            <p>
              <strong>Geschäftsführung:</strong> Lukas Kaminski & Damian Kierzek
              <br />
              <strong>Telefon (DE):</strong>{" "}
              <a
            ...
            <p>
              <strong>Registergericht:</strong> Amtsgericht Walsrode
              <br />
        ...
        <Card className="border-2 border-border bg-card">
          <CardHeader>
            <CardTitle className="uppercase tracking-widest text-lg font-black text-muted-foreground">
              5. Webanalyse (Google Analytics & Vercel Analytics)
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed text-sm">
            <div>
              ...
              <p>
                ...
                Irland). Google Analytics verwendet Technologien (z. B. Cookies
                oder ähnliche Identifikatoren), um die Nutzung der Website zu
                analysieren. Die dadurch erzeugten Informationen können an
                Server von Google in den USA übertragen und dort gespeichert
                werden.
              </p>
              <p className="mt-2">
                Wir setzen Google Analytics ein, um die Nutzung unserer Website
                auszuwerten und unser Angebot zu verbessern. Rechtsgrundlage ist
            ...
            <div>
              ...
              <p>
                Zusätzlich nutzen wir Vercel Analytics zur Messung von
                Seitenaufrufen und Performance. Anbieter ist Vercel Inc. (USA).
                Die Verarbeitung erfolgt zur Auswertung der Website-Nutzung und
                Stabilität.
              </p>
              <p className="mt-2">
        ...
        <Card className="border-2 border-border bg-card">
          ...
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed text-sm">
            <p>
              Für den Versand von E-Mails nutzen wir den Dienst{" "}
            ...
            <p className="mt-2">
              Wenn Sie uns eine Anfrage über unser Kontaktformular senden,
              werden Ihre Daten (Name, E-Mail-Adresse, Nachricht) über Resend
              versendet. Resend verarbeitet diese Daten ausschließlich in
              unserem Auftrag und darf sie nicht für eigene Zwecke nutzen.
            </p>
            <p className="mt-2">
              Details zur Datenverarbeitung durch Resend finden Sie hier:{" "}
              <a
            ...
            <p className="mt-2">
              Die Nutzung von Resend erfolgt auf Grundlage von Art. 6 Abs. 1
          ...
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed text-sm">
            ...
            <ul className="list-disc list-inside space-y-2 ml-2">
              ...
              <li>
                ...
                Recht auf Datenübertragung an Dritte
              </li>
              <li>
                <strong className="text-foreground">
        ...
        <div className="text-center pt-8 space-y-4">
          ...
          <Link
            href="/"
            className="text-primary hover:underline font-bold text-sm inline-block"
          >
