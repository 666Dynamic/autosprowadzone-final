...
export const metadata: Metadata = {
  ...
  description:
    "Sprawdzenie auta przed zakupem w Niemczech. Inspekcja techniczna, pomiar lakieru, diagnostyka komputerowa. Obsługujemy region Bremen i całe Niemcy. Raport ze zdjęciami w 24h.",
  alternates: {
  ...
  openGraph: {
    title: "Weryfikacja Aut w Niemczech — Inspekcja Przed Zakupem",
    description:
      "Inspekcja techniczna auta w Niemczech: pomiar lakieru, diagnostyka, raport ze zdjęciami.",
        ...
        <div className="max-w-6xl mx-auto space-y-24">
          ...
          <div className="text-center space-y-6">
            ...
            <h1 className="text-3xl md:text-5xl lg:text-7xl font-black leading-none uppercase tracking-tighter text-foreground italic">
              Weryfikacja <br />
              <span className="text-primary not-italic">Zanim Kupisz</span>
            </h1>
            <p className="text-base text-muted-foreground font-medium max-w-3xl mx-auto leading-relaxed">
              Nie ryzykuj oszczędności życia. Wyślij naszego eksperta na
              miejsce, aby sprawdził auto od osoby prywatnej lub dealera w
              całych Niemczech.
            </p>
          </div>
              ...
              <div className="bg-gradient-to-br from-amber-400 via-amber-500 to-amber-600 rounded-[1.75rem] md:rounded-[2.5rem] flex flex-col lg:flex-row items-stretch relative overflow-hidden">
                ...
                <div className="lg:w-3/5 p-6 md:p-14 space-y-6 md:space-y-8 relative z-10 flex flex-col justify-center">
                  ...
                  <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white uppercase tracking-tighter leading-[0.9] italic drop-shadow-lg">
                    ...
                    <span className="not-italic">Sprawdzimy je dla Ciebie</span>
                  </h2>
                  <p className="text-sm md:text-lg text-white/95 font-medium leading-relaxed max-w-2xl drop-shadow-sm">
                    Znalazłeś interesującą ofertę w Niemczech? Nie ryzykuj
                    wyjazdu w ciemno. Nasi eksperci przeprowadzą dla Ciebie
                    pełną weryfikację sprzedawcy oraz audyt techniczny na
                    miejscu.
                  </p>
                  <div className="flex flex-wrap gap-2 md:gap-4 pt-2 md:pt-4">
                    {[
                      ...
                      <div
                        key={i}
                        className="px-3 py-1.5 md:px-5 md:py-2.5 bg-white/10 md:bg-white/20 rounded-lg md:rounded-xl border border-white/20 md:border-white/30 text-white font-bold text-[10px] md:text-xs uppercase tracking-wider drop-shadow-md"
                      >
                        {tag}
                      </div>
                    ))}
                ...
                <div className="lg:w-2/5 p-4 md:p-8 relative flex flex-col justify-end min-h-[350px] md:min-h-[400px]">
                  ...
                  <div className="relative z-10 p-5 md:p-6 rounded-2xl shadow-2xl space-y-4 overflow-hidden bg-card text-card-foreground border border-border">
                    ...
                    <div className="space-y-2 relative z-10">
                      <div className="text-[10px] font-bold uppercase tracking-widest bg-primary/20 text-primary px-3 py-1 rounded-full w-fit border border-primary/20">
                        Weryfikacja pod Bremen
                      </div>
                      <div className="flex items-baseline gap-2">
                        <span className="text-2xl md:text-3xl lg:text-5xl font-black tracking-tighter uppercase leading-none text-foreground dark:text-white font-display italic">
                          250 €
                        </span>
                      </div>
                      <p className="font-bold text-[11px] md:text-sm text-muted-foreground leading-relaxed">
                        Pełna inspekcja techniczna, pomiar lakieru, diagnostyka
                        komputerowa i kompleksowy raport rzeczoznawcy.
                      </p>
                    </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              <div className="space-y-8 bg-card p-10 rounded-[3rem] border border-primary/30 shadow-lg">
                ...
                <h3 className="text-3xl font-black uppercase tracking-tighter text-foreground leading-none line-clamp-2">
                  Dealerzy i Salony <br />
                  <span className="text-primary italic">
                    Mobile.de / AutoScout24
                  </span>
                </h3>
                <p className="text-muted-foreground font-medium leading-relaxed">
                  Większość profesjonalnych ogłoszeń pochodzi od Autohausów.
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li
                      key={i}
                      className="flex gap-3 text-sm font-bold text-foreground/80 lowercase first-letter:uppercase"
                    >
              ...
              <div className="space-y-8 bg-card p-10 rounded-[3rem] border border-primary/30 shadow-lg relative overflow-hidden">
                ...
                <p className="text-muted-foreground font-medium leading-relaxed">
                  Tu czyha najwięcej pułapek. Kupując od osoby prywatnej,
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="space-y-8">
                <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter text-foreground leading-none">
                  Ryzyka zakupu <br />
                  <span className="text-primary italic">na własną rękę</span>
                </h2>
                <p className="text-muted-foreground font-medium leading-relaxed">
                  Rynek niemiecki, choć uchodzi za wzorowy, pełen jest pułapek
                  zastawianych na kupujących z zagranicy. Oszustwa na eBay
                  Kleinanzeigen stały się plagą.
                </p>
                <div className="space-y-4">
                  {[
                    {
                      t: "Oszustwa na zaliczkę",
                      d: "Fikcyjne ogłoszenia w super cenach. Sprzedawca prosi o zaliczkę na transport i znika.",
                    },
                    {
                      t: "Ukryta historia wypadkowa",
                      d: "Auta ze szkodą całkowitą naprawiane tanim kosztem i sprzedawane jako bezwypadkowe.",
                    },
                    {
                      t: "Cofnięte liczniki",
                      d: "Proceder ten nadal dotyczy ok. 30% aut eksportowych z Niemiec.",
                    },
                    {
                      t: "Wady ukryte silnika",
                      d: "Sprzedawcy prywatni często pozbywają się aut tuż przed drogimi naprawami (DPF, turbo, rozrząd).",
                    },
                  ].map((risk, i) => (
                    <div
                      key={i}
                      className="flex gap-4 p-4 rounded-2xl bg-red-500/5 border border-red-500/10"
                    >
                      <div className="mt-1 text-red-500 font-black">!</div>
                      <div>
                        <h4 className="font-black uppercase text-xs text-red-600 dark:text-red-300">
                          {risk.t}
                        </h4>
              ...
              <div className="bg-card border-2 border-primary/30 p-10 rounded-[2.5rem] shadow-xl relative overflow-hidden">
                ...
                <h3 className="text-2xl font-black mb-8 flex items-center uppercase tracking-tight text-foreground">
                  <Search className="mr-3 h-8 w-8 text-primary" /> Zakres
                  Inspekcji
                </h3>
                <ul className="space-y-6 relative z-10">
                  {[
                    {
                      title: "Lakier i Nadwozie",
                      desc: "Pomiar grubości powłoki na każdym elemencie, wykrywanie napraw blacharskich i szpachli. Sprawdzenie oryginalności szwów i zgrzewów.",
                    },
                    {
                      title: "Diagnostyka & Silnik",
                      desc: "Pełny odczyt błędów (DTC). Analiza parametrów pracy turbiny, wtrysków i filtra DPF w czasie jazdy próbnej.",
                    },
                    {
                      title: "Układ Jezdny i Hamulcowy",
                      desc: "Weryfikacja stanu zawieszenia i układu kierowniczego. Sprawdzenie zużycia tarcz, klocków oraz stanu opon.",
                    },
                    {
                      title: "Weryfikacja Historii & VIN",
                      desc: "Sprawdzenie wpisów w międzynarodowych bazach ASO i autentyczności przebiegu (TÜV/Dekra).",
                    },
                    {
                      title: "AVILOO (EV/Hybrid)",
                      desc: "Certyfikowany test stanu zdrowia baterii (SoH). Kluczowy przy autach elektrycznych.",
                    },
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4 group/item">
                      <div className="bg-primary text-white font-black p-1 rounded-lg h-8 w-8 flex items-center justify-center shrink-0 text-xs shadow-md group-hover/item:scale-110 transition-transform font-sans">
                        0{idx + 1}
                      </div>
                      <div>
                        <h4 className="font-black text-foreground uppercase tracking-tight mb-1 group-hover/item:text-primary transition-colors text-base">
                          {item.title}
                        </h4>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch pt-12">
            ...
            <div className="bg-card/80 backdrop-blur-sm text-card-foreground p-6 md:p-8 rounded-[2.5rem] shadow-2xl relative overflow-hidden flex flex-col justify-between border border-border min-h-[500px] md:min-h-[450px] lg:min-h-[500px]">
              <div className="absolute top-0 right-0 bg-primary text-primary-foreground px-3 md:px-6 lg:px-8 py-2 md:py-3 font-black text-[10px] md:text-xs uppercase tracking-widest rounded-bl-2xl md:rounded-bl-3xl z-10 max-w-[60%] text-center leading-tight">
              ...
              <div className="space-y-4 md:space-y-5 relative z-10 pt-4 md:pt-3">
                ...
                <p className="text-muted-foreground text-sm font-bold uppercase tracking-widest leading-tight">
                  Obszar do 100km od Osterholz-Scharmbeck
                </p>
                ...
                <div className="space-y-3 md:space-y-4">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3">
                      ...
                      <span className="text-xs md:text-sm font-bold uppercase tracking-tight text-foreground leading-relaxed">
                        {item}
                      </span>
                    </div>
                  ))}
              ...
              <div className="pt-10 md:pt-12 flex flex-col gap-4 relative z-10">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
                  ...
                  <a
                    href="#form"
                    className="bg-primary hover:bg-primary/90 text-primary-foreground transition-all px-5 md:px-6 py-2.5 md:py-3 rounded-xl font-bold text-sm shadow-md hover:shadow-lg w-full sm:w-auto text-center"
                  >
                    Zamów teraz
                  </a>
                </div>
            ...
            <div className="bg-card/80 backdrop-blur-sm text-card-foreground p-6 md:p-8 rounded-[2.5rem] shadow-xl flex flex-col justify-between border border-border min-h-[500px] md:min-h-[450px] lg:min-h-[500px]">
              <div className="space-y-8">
                ...
                <p className="text-muted-foreground text-sm font-bold uppercase tracking-widest leading-tight">
                  Berlin, Hamburg, Monachium i okolice
                </p>

                <p className="text-foreground/80 font-bold leading-relaxed text-sm">
                  Dla aut poza naszym głównym regionem przygotowujemy
                  indywidualną kalkulację kosztów dojazdu. Współpracujemy z
                  rzeczoznawcami w całych Niemczech, co gwarantuje szybki czas
                  reakcji.
                </p>
                ...
                <div className="bg-primary/5 p-6 rounded-2xl border border-primary/10">
                  ...
                  <ul className="mt-4 space-y-3">
                    <li className="text-xs font-bold text-muted-foreground uppercase flex gap-2">
                      <div className="text-primary">•</div> Weryfikacja
                      dostępności rzeczoznawcy
                    </li>
                    <li className="text-xs font-bold text-muted-foreground uppercase flex gap-2">
                      <div className="text-primary">•</div> Kalkulacja kosztów
                      dojazdu i paliwa
                    </li>
                    <li className="text-xs font-bold text-muted-foreground uppercase flex gap-2">
                      <div className="text-primary">•</div> Realizacja zazwyczaj
                      w 24-48h
                    </li>
                  </ul>
                </div>
              ...
              <div className="pt-6 md:pt-8 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
                <div>
                  ...
                  <div className="text-xl md:text-2xl font-black text-foreground tracking-tighter uppercase whitespace-nowrap">
                    Kontakt
                  </div>
                </div>
                <a
                  href="#form"
                  className="border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-all px-5 md:px-6 py-2.5 md:py-3 rounded-xl font-bold text-sm shadow-md hover:shadow-lg w-full sm:w-auto text-center"
                >
                  Zapytaj o cenę
                </a>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 pb-12">
            <div className="bg-secondary/30 p-8 rounded-[2rem] border-2 border-transparent text-center group hover:border-primary transition-all shadow-sm">
              ...
              <h3 className="font-black uppercase text-sm mb-2 text-foreground">
                Szybkość
              </h3>
              <p className="text-xs text-muted-foreground font-bold leading-relaxed">
                Wstępna analiza ogłoszenia w 2h. Inspekcja na miejscu zazwyczaj
                do 24h.
              </p>
            </div>
            <div className="bg-secondary/30 p-8 rounded-[2rem] border-2 border-transparent text-center group hover:border-primary transition-all shadow-sm">
              ...
              <p className="text-xs text-muted-foreground font-bold leading-relaxed">
                Koszt audytu najczęściej zwraca się kilkukrotnie dzięki
                skutecznym negocjacjom.
              </p>
            </div>
            <div className="bg-secondary/30 p-8 rounded-[2rem] border-2 border-transparent text-center group hover:border-primary transition-all shadow-sm">
              ...
              <p className="text-xs text-muted-foreground font-bold leading-relaxed">
                Odrzucamy 7 na 10 sprawdzanych aut. Kupujemy tylko te godne
                polecenia.
              </p>
            </div>
          </div>
