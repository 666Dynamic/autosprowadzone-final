  ...
  return (
    <div className="flex items-center gap-3">
      <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-primary shadow-[0_0_20px_rgba(245,158,11,0.4)]">
        ...
        >
          <path
            d="M20 50 L35 50 C37 50 38 49 39 47 L45 35 C47 30 55 30 57 35 L63 47 C64 49 65 50 67 50 L85 50"
            stroke="white"
            strokeWidth="6"
            strokeLinecap="round"
          />
      ...
      <div className="flex items-baseline tracking-tighter uppercase font-extrabold">
        ...
        <span className="text-muted-foreground/30 text-xs ml-0.5 font-bold">
          .pl
        </span>
      </div>
    </div>
  ...
  return (
    <div className="flex items-center gap-3">
      <div className="relative flex items-center justify-center w-12 h-12">
        ...
        >
          <path
            d="M50 5 L15 25 V55 C15 75 50 95 50 95 C50 95 85 75 85 55 V25 L50 5Z"
            fill="#F59E0B"
          />
          <path
      ...
      <div className="max-w-4xl mx-auto space-y-20">
        <div className="space-y-4 text-center">
          <h1 className="text-4xl font-bold tracking-tight">
            Propozycje Logo dla SprowadzoneAuto.pl
          </h1>
          <p className="text-muted-foreground text-lg">
            Wybierz wersję, która najlepiej oddaje charakter Twojej marki.
          </p>
        </div>
        ...
        <div className="grid gap-16">
          ...
          <section className="space-y-6 p-8 border border-border rounded-3xl bg-card/50 backdrop-blur">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-semibold opacity-50">
                #1 Minimalistyczna Linia (Sleek Modern)
              </h2>
            ...
            <p className="text-sm text-muted-foreground italic text-center">
              Skupienie na czystości formy i nowoczesnym druku. Agresywna, ale
              elegancka linia dachu.
            </p>
          </section>
          ...
          <section className="space-y-6 p-8 border border-border rounded-3xl bg-card/50 backdrop-blur">
            <h2 className="text-xl font-semibold opacity-50">
              #2 Tarcza Bezpieczeństwa (Corporate Trust)
            </h2>
            <div className="py-10 flex justify-center scale-125">
              <LogoVariant2 />
            </div>
            <p className="text-sm text-muted-foreground italic text-center">
              Symbol tarczy buduje natychmiastowe zaufanie. Sugeruje, że każde
              auto jest zweryfikowane i bezpieczne.
            </p>
          </section>
          ...
          <section className="space-y-6 p-8 border border-border rounded-3xl bg-card/50 backdrop-blur">
            <h2 className="text-xl font-semibold opacity-50">
              #3 Blokowy Dynamiczny (Bold Action)
            </h2>
            <div className="py-10 flex justify-center scale-125">
              <LogoVariant3 />
            </div>
            <p className="text-sm text-muted-foreground italic text-center">
              Bardzo silna obecność wizualna. Idealne dla marki, która chce
              dominować i być zapamiętana.
            </p>
          </section>
        </div>
