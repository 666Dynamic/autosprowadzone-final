  ...
  return (
    <article className="container mx-auto px-4 md:px-8 py-12 md:py-20">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Powiązane artykuły */}
        <div className="mt-12">
          <h3 className="text-lg md:text-xl font-black uppercase tracking-tight mb-4">
            Powiązane tematy
          </h3>
            ...
            {allPosts
              ...
              .map((rel) => (
                <Link
                  key={rel.slug}
                  href={`/blog/${rel.slug}`}
                  className="group border border-border rounded-2xl p-4 hover:border-primary/40 transition-colors"
                >
