            ...
            <div className="container mx-auto px-4 md:px-8 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="flex flex-col space-y-3">
                    ...
                    <div className="flex gap-4 mt-4">
                        <a href="https://www.facebook.com/sprowadzoneauto/" target="_blank" rel="noopener noreferrer" aria-label="Odwiedź nasz profil na Facebooku" className="text-slate-400 hover:text-[#1877F2] transition-colors">
                        ...
                        <a href="https://wa.me/4915679264391" target="_blank" rel="noopener noreferrer" aria-label="Skontaktuj się przez WhatsApp" className="text-slate-400 hover:text-[#25D366] transition-colors">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" role="img">
