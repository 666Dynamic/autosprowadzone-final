      ...
      <div className="container relative z-10 mx-auto px-4 md:px-8">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-6 md:space-y-10 -mt-8 md:-mt-20">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black tracking-tighter leading-[0.9] uppercase italic">
            ...
            <span className="text-primary not-italic drop-shadow-[0_2px_8px_rgba(0,0,0,0.15)]">
              Indywidualne Zamówienie
            </span>
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-2xl leading-relaxed px-2 md:px-0">
            Twój osobisty broker w Niemczech. Pozyskujemy auta z pewnych źródeł:
            licytacje B2B, floty bankowe oraz sprawdzeni dealerzy. Pełna
            weryfikacja i dostawa pod dom.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-4 w-full sm:w-auto px-4 md:px-0">
            <Link href="/#zlecenie">
              <Button
                size="lg"
                className="bg-primary text-primary-foreground hover:bg-primary/90 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 transition-all w-full sm:w-auto h-14 md:h-14 px-8 font-bold rounded-lg shadow-lg [text-shadow:0_1px_2px_rgba(0,0,0,0.2)] min-h-[56px] touch-manipulation"
                aria-label="Zamów bezpłatną wycenę importu auta"
              >
            ...
            <Link href="#process-section">
              <Button
                size="lg"
                variant="outline"
                className="bg-accent/10 text-accent hover:bg-accent/20 focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 transition-all border border-accent w-full sm:w-auto h-14 md:h-14 px-8 font-bold rounded-lg min-h-[56px] touch-manipulation"
                aria-label="Zobacz proces importu auta"
              >
          ...
          <div className="mt-2 text-[11px] md:text-xs text-muted-foreground font-bold uppercase tracking-widest">
            Stała prowizja: <span className="text-foreground">2500 zł</span> •
            Typowa oszczędność vs portale:{" "}
            <span className="text-foreground">20–30%</span>.
            <Link
              href="/kalkulator"
              className="ml-2 underline decoration-primary/30 underline-offset-4 hover:text-primary"
            >
              Zobacz kalkulację
            </Link>
          </div>
