            ...
            <div className="container mx-auto px-4 md:px-8 relative z-10">
                ...
                <div className="grid md:grid-cols-3 gap-8 text-foreground">
                    {features.map((feature, idx) => (
                        <div
                            key={idx}
                            className="bg-background p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-[2rem] md:rounded-2xl border-2 border-primary/20 shadow-sm hover:shadow-lg hover:shadow-primary/10 hover:scale-[1.01] sm:hover:scale-[1.02] md:hover:scale-105 hover:border-primary/40 transition-all duration-300"
                        >
                            <div className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 bg-primary/20 border-2 border-primary/30 rounded-lg sm:rounded-xl flex items-center justify-center mb-4 sm:mb-5 md:mb-6 text-primary">
