...
// Cache formatter outside component to prevent re-instantiation on every render/bidding cycle update
...
export function AboutAuctions() {
  ...
  const formattedPrice = useMemo(() => priceFormatter.format(price), [price]);
