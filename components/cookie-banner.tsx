            ...
            <AnimatePresence>
                {showSettings && (
                    ...
                    >
                        ...
                        >
                            <h3 className="text-xl font-black text-white mb-4 uppercase tracking-tight">Ustawienia Cookies</h3>
                            <div className="space-y-4 mb-6">
                                <div className="bg-slate-900 p-4 rounded-xl border border-slate-800">
                                    <p className="text-sm text-slate-300 font-bold mb-2">Status: 
                                        <span className={hasConsent === "accepted" ? "text-green-400 ml-2" : "text-red-400 ml-2"}>
                                            {hasConsent === "accepted" ? "Zaakceptowane" : "Odrzucone"}
                                        </span>
                                    </p>
