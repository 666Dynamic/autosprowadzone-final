...
// Cache for Intl.NumberFormat instances to prevent expensive instantiations during rapid React re-renders.
// Improves CPU performance measurably, especially in loops or frequently updated components.
...
// Cached formatter for standard numbers
