...
// Cache formatters to avoid expensive Intl.NumberFormat instantiation on every call
...
// Cache formatter to avoid expensive Intl.NumberFormat instantiation on every call
