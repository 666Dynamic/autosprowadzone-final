...
export async function getAllPosts(): Promise<PostMetadata[]> {
  try {
    ...
    const posts = files
      ...
      // Performance optimization: String comparison is ~10x faster than instantiating Date objects
      // Works reliably because dateISO follows the YYYY-MM-DD ISO 8601 format
      .sort((a, b) =>
        b.dateISO > a.dateISO ? 1 : b.dateISO < a.dateISO ? -1 : 0
      );
